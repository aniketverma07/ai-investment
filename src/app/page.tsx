                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="p-6 rounded-xl bg-white/5 backdrop-blur-sm">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {[
                          { amount: '500', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mb-1 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> },
                          { amount: '1000', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mb-1 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></svg> },
                          { amount: '5000', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mb-1 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 8h6m-5 0a3 3 0 110 6H9l3 3m-3-6h6m6 1a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> },
                          { amount: '10000', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mb-1 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg> }
                        ].map(({ amount, icon }) => (
                          <button
                            key={amount}
                            type="button"
